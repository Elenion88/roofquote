...
export function CalibrationCard() {
  ...
  return (
    <details className="rounded-2xl border border-stone-200 bg-stone-50/50 p-6">
      <summary className="cursor-pointer flex items-center justify-between">
        <span className="font-medium text-stone-900">How accurate are we? <span className="ml-2 text-stone-500 text-sm font-normal">(calibration data)</span></span>
